#ifndef _PERSEUS_DEFS
#define _PERSEUS_DEFS
...
// Colors
#define RGB_RAW_White 1, 1, 1
#define RGB_RAW_Black 0, 0, 0
#define RGB_RAW_Yellow 1, 1, 0
#define RGB_RAW_Magenta 1, 0, 1
#define RGB_RAW_Cyan 0, 1, 1
#define RGB_RAW_Blue 0, 0, 1
#define RGB_RAW_Green 0, 1, 0
#define RGB_RAW_Red 1, 0, 0

#define RGB_ARR_White {1, 1, 1, 1}
#define RGB_ARR_None {1, 1, 1, 0}
#define RGB_ARR_Black {0, 0, 0, 1}
#define RGB_ARR_Zero {0, 0, 0, 0}

#define RGB_TEX_White "#(argb,1,1,1)color(1,1,1,1)"
#define RGB_TEX_None "#(argb,1,1,1)color(1,1,1,0)"
#define RGB_TEX_Black "#(argb,1,1,1)color(0,0,0,1)"
#define RGB_TEX_Zero "#(argb,1,1,1)color(0,0,0,0)"

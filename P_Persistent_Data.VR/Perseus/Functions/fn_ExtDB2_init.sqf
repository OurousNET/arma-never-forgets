/*
	Function Name: Perseus_fnc_ExtDB2_init
	File: fn_ExtDB2_init.sqf
	Author:
	Description:
...
if ( isNil {uiNamespace getVariable "EXTDB_SQL_Perseus"}) then
{
	// extDB Version
	...
	EXTDB_SQL_Perseus = compileFinal _extDB_SQL_CUSTOM_ID;
	...
	// Save Randomized ID
	uiNamespace setVariable ["EXTDB_SQL_Perseus", _extDB_SQL_CUSTOM_ID];
	_return = true;
}
else
{
	EXTDB_SQL_Perseus = compileFinal str(uiNamespace getVariable "EXTDB_SQL_Perseus");
